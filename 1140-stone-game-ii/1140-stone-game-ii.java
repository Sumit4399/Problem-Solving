...
//     public int help(int []piles, int [][] dp, int []suffixSum, int i, int M){
...
//         for(int x=0; x<=2*M; x++)
//         {
//            result = Math.max(result, suffixSum[i] - help(piles, dp, suffixSum, i + x, Math.max(M, x)));
//         }
...
//         return help(piles, dp, suffixSum, 0,1); 
//     }
